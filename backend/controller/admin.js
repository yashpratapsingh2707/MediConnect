...
const all_appointments = async (req, res) => {
    ...
    try {
        ...
        const all_appointmentk = await appointments.find()
        console.log("jjjjjjjjjjjjjjjjjjj"+all_appointmentk.payment+"lllllllllllllllllllllllllllll");
        if (!all_appointments) {
            return res
                .status(401)
            ...
            //     console.log(`User: ${userName}, Doctor: ${doctorName}`);
            // });
